...
public record CauldronAlloyerS2CPayload(int[] items, BlockPos pos) implements CustomPayload {
    ...
    private static CauldronAlloyerS2CPayload read(RegistryByteBuf registryByteBuf) {
        return new CauldronAlloyerS2CPayload(registryByteBuf.readIntArray(), registryByteBuf.readBlockPos());
    }
