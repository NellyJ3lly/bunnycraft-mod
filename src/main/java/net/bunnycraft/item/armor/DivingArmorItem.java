...
public class DivingArmorItem extends ModArmorItem implements Equipment {
    private final Supplier<AttributeModifiersComponent> attributeModifiers;

    public DivingArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings, float water_movement_speed,float oxygen_bonus,float submerged_mining_speed,float movement_speed, float jump_power) {
