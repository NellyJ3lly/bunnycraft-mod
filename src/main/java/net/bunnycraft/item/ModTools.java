...
public class ModTools  {
    ...
    static final int spearDmg = 3; // the base spear damage as a variable for easy balancing
...
// each spear requires 3 json files, and 2 textures
...
// i recomend just copying these and changing the texture and name of the json
// spear.json is the 3d model file shown in hand
// spear_item.json is the 2d texture shown in gui
// spear_throwing.json is the upsidown spear model. it must be flipped because when charging, otherwise it will show backwards

//declare the spear as normal but use spearDmg variable as the attack damage so we can balence it later if needed

//add the new spear into ItemRendererMixin and target the spear_item.json, this makes sure it renders the 2d texture in inventory
//load the spear_item.json model in the ModelLoaderMixin class 

//add the material to the case statement in SpearEntity

//add the texture for the model and extend the case statement in SpearRenderer

//add the predicate "charging" in ModModelPredicates
