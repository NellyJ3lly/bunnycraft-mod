...
public class EnchantingStandEntity extends BlockEntity implements Nameable {
    public int ticks;
    ...
    public EnchantingStandEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ENCHANTING_STAND_ENTITY, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, EnchantingStandEntity blockEntity) {
    ...
    @Override
    public Text getName() {
        return (Text) (this.customName != null ? this.customName : Text.translatable("container.bunnycraft.enchanting_gui_title"));
    }
