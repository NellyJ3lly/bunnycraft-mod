...
public class CauldronAlloyerEntity extends BlockEntity implements ImplementedInventory {
    ...
    //TODO make the cauldron fill partially with liquid based on how much liquid is in the cauldron.
    // so 1 alloy would increment the alloyAmount variable and 1 would corespond to an 8th of the way full

    //TODO add bucket items and allow for pulling liquid out of the cauldron

    // possibly make the cauldron take your entire hand stack up to the maxStackPerItem variable
