...
public class EnchantingStandScreen extends HandledScreen<EnchantingStandScreenHandler> {
    ...
    public EnchantingStandScreen(EnchantingStandScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (int j = 0; j < 3; j++) {
            ...
            Optional<Reference<Enchantment>> optional = this.client.world.getRegistryManager().get(RegistryKeys.ENCHANTMENT).getEntry(this.handler.enchantmentId[j]);
            if (!optional.isEmpty()) {
